...
private:
    ...
    void handleGetAvailableGPUs(const fbs::cuda::ipc::api::GetAvailableGPUsRequest* req,
                                flatbuffers::FlatBufferBuilder& response_builder,
                                std::chrono::time_point<std::chrono::steady_clock> start_timestamp);
    void handleGetAllocatedTotalBufferCount(const fbs::cuda::ipc::api::GetAllocatedTotalBufferCountRequest* req,
                                            flatbuffers::FlatBufferBuilder& response_builder,
                                            std::chrono::time_point<std::chrono::steady_clock> start_timestamp);
    void handleGetAllocatedTotalBytes(const fbs::cuda::ipc::api::GetAllocatedTotalBytesRequest* req,
                                      flatbuffers::FlatBufferBuilder& response_builder,
                                      std::chrono::time_point<std::chrono::steady_clock> start_timestamp);
    void handleGetMaxAllocationBytesRequest(const fbs::cuda::ipc::api::GetMaxAllocationBytesRequest* req,
                                            flatbuffers::FlatBufferBuilder& response_builder,
                                            std::chrono::time_point<std::chrono::steady_clock> start_timestamp);
    ...
    std::unordered_map<boost::uuids::uuid, prometheus::Gauge*, boost::hash<boost::uuids::uuid>> allocated_buffers_map_;
    // key gpu_uuid
    std::unordered_map<boost::uuids::uuid, prometheus::Gauge*, boost::hash<boost::uuids::uuid>> allocated_bytes_map_;
    // key gpu_uuid
